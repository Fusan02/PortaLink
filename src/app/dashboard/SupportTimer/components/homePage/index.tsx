        ...
        <>
            ...
            <div className={index.description}>
                <section className={index.descriptionSection}>
                    <h3 className={index.descriptionSectionTitle}>
                        タイマーの使い方
                    </h3>
                    <p className={index.descriptionText}>
                        「▶︎
                        Start」ボタンを押すと作業時間の計測が開始されます。作業が終わったら「◽️
                        Stop」ボタンを押してください。メモやタグを追加して記録を保存できます。
                    </p>
                </section>
                ...
                <section className={index.descriptionSection}>
                    ...
                    <ul className={index.descriptionList}>
                        <li className={index.descriptionListItem}>
                            <strong>Stats:</strong>{' '}
                            作業時間の統計データを確認できます。日別、週別、月別の作業時間や傾向を分析できます。
                        </li>
                        <li className={index.descriptionListItem}>
                            <strong>History:</strong>{' '}
                            過去の作業記録を一覧で確認できます。メモやタグで検索・フィルタリングも可能です。
                        </li>
                        <li className={index.descriptionListItem}>
